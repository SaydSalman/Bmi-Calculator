  ...
  return (
    <>
      <div className='d-flex justify-content-center align-items-center wrapper  ' style={{width:'100%',height:'100vh'}}>
        ...
        <div style={{width:'100%',height:'150px'}} className='d-flex justify-content-center align-items-center flex-column bg-info'>
          <h1  style={{height:'50px'}}>Your BMI is : {bmi} </h1>
          
          <p className='fw-bolder'>{msg}</p>
          <p className='fw-bolder'>Body Mass Index is a person’s weight in kilograms divided by the square of height in meters.</p>
        </div>
        <form  onSubmit={handleCalculate}>
          ...
          <div className='d-flex justify-content-between gap-2'>
            <button disabled={validAge&&validHeight&&validWeight?false:true} type='submit' style={{width:'50%',height:'70px'}} className='btn btn-success'>Calculate</button>
            <a onClick={handlereset} style={{width:'50%',height:'70px',padding:'20px'}} className='btn btn-danger'>Reload</a>
          </div>
        </form>
